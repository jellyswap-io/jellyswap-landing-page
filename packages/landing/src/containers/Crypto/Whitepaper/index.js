  ...
  return (
    <WhitepaperWrapper id="whitepaper">
      <Container>
        ...
        <Text
          {...text}
          content="With Smart Contracts being released on the Cardano network later this year, there is a great need for a market to trade the new currencies that will pop up. This whitepaper describes JellySwap, a decentralized exchange (DEX) built on the Cardano blockchain. It will be modeled after the popular Uniswap on the Ethereum blockchain but will offer more attractive fees due to Cardano’s greater efficiency. Anyone can serve as a liquidity provider on JellySwap, creating a market for others to exchange their Cardano tokens. Traders pay a small fee of 0.25%, giving liquidity providers profit in return for providing liquidity."
        />
        <Text {...sectionTitle} content={'Background'} />
        <p style={text}>
          JellySwap is a “Decentralized Exchange” (DEX), an application running
          on smart contracts on the Cardano Blockchain. Rather than relying on a
          central entity such as a bank, JellySwap aims to create a free
          financial market relying on these smart contracts to manage
          transactions.
          <br />
          <br />
        ...
        <p style={text}>
          ...
          creating a stable source of demand while reducing the supply of $JELLY
          on the market
          <br />
